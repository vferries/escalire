...
- Les plumes qui tombent sont recréées avec 3 wrappers imbriqués (trajectoire physique WAAPI / frémissement / rotation-teinte) sous un wrapper externe (position + rafale JS) — ne pas fusionner les transforms.
