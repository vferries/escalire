...
- **Animations** : IntersectionObserver + transforms/opacity uniquement (pas de layout thrash). Respecter `prefers-reduced-motion` ET le réglage d'intensité (immersif/équilibré/discret) persisté côté client.
