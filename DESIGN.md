...
| `ink-wash-*.png`, `ink-splat-*.png`, `ink-accent-*.png` | Taches d'encre **générées** (`tools/gen-ink.mjs`, spec 2026-07-11) — sprites verticaux 10 frames (768×7680, gris+alpha) : éclosion + état final | remplacent `ink-splat.png` (jugé non convaincant par Vincent) ; éclaboussures et aquarelles décoratives |
